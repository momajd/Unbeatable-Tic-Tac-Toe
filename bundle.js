...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var BoardComponent = __webpack_require__(169);
	var Board = __webpack_require__(171);
	var Player = __webpack_require__(172);
	var ComputerPlayer = __webpack_require__(173);
	...
	var Game = React.createClass({
	  ...
	  updateBoard: function updateBoard(pos) {
	  ...
	  restartGameAsX: function restartGameAsX() {
	    this.setState({ board: new Board(), userGoesFirst: true });
	  },
	
	  restartGameAsO: function restartGameAsO() {
	    var p1 = new ComputerPlayer('x'),
	        p2 = new Player('o');
	  ...
	  render: function render() {
	    ...
	    if (this.state.board.isWon() || this.state.board.isTie()) {
	      ...
	      var endMessage = this.state.board.isWon() ? React.createElement(
	        'p',
	        ...
	        'p',
	        { className: 'end-message' },
	        'Not too bad, considering that it\'s impossible to win..'
	      );
	
	      var fontAwesomeO = React.createElement('i', { className: 'fa fa-circle-o fa-4x', 'aria-hidden': 'true' });
	      var fontAwesomeX = React.createElement('i', { className: 'fa fa-times fa-4x', 'aria-hidden': 'true' });
	      ...
	      modal = React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { className: 'button', onClick: this.restartGameAsX },
	            'Play Again as ',
	          ...
	          React.createElement(
	            'button',
	            { className: 'button', onClick: this.restartGameAsO },
	            'Play Again as ',
	            React.createElement('br', null),
	            ' ',
	            fontAwesomeO
	          ...
	          React.createElement(
	            'a',
	            { href: 'https://github.com/momajd/Unbeatable-Tic-Tac-Toe' },
	    ...
	    return React.createElement(
	      ...
	      modal,
	      React.createElement(BoardComponent, { board: this.state.board, updateBoard: this.updateBoard })
	    );
	  }
	...
	var Tile = React.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.props.mark === "x") {
	      mark = React.createElement('i', { className: 'fa fa-times fa-5x', 'aria-hidden': 'true' });
	    } else if (this.props.mark === "o") {
	      mark = React.createElement('i', { className: 'fa fa-circle-o fa-5x', 'aria-hidden': 'true' });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = function Board(player1, player2, turn) {
	...
	Board.prototype.diagonals = function () {
	  ...
	  var diags = [];
	  diags.push(topLeft.map(function (pos) {
	    return this.markAt(pos);
	  }, this));
	  diags.push(topRight.map(function (pos) {
	    return this.markAt(pos);
	  }, this));
	  return diags;
	};
	...
	Board.prototype.winner = function () {
	  ...
	  var mark1 = this.player1.mark,
	      mark2 = this.player2.mark;
	...
	Board.prototype.isTie = function () {
	  ...
	  var flattened = this.rows.reduce(function (a, b) {
	    return a.concat(b);
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TicTacToeNode = __webpack_require__(174);
	
	var ComputerPlayer = function ComputerPlayer(mark) {
	  this.mark = mark;
	};
	...
	ComputerPlayer.prototype.move = function (board) {
	  ...
	  for (var i = 0; i < possibleMoves.length; i++) {
	    ...
	    if (move.isWinningNode(this.mark)) {
	      return move.prevMovePos;
	    }
	  }
	  ...
	  for (var j = 0; j < possibleMoves.length; j++) {
	    ...
	    if (!move.isLosingNode(this.mark)) {
	      return move.prevMovePos;
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TicTacToeNode = function TicTacToeNode(board, prevMovePos) {
	  this.board = board;
	...
	TicTacToeNode.prototype.isLosingNode = function (evaluator) {
	  ...
	  if (this.board.turn === evaluator) {
	    ...
	    for (var i = 0; i < children.length; i++) {
	      if (!children[i].isLosingNode(evaluator)) {
	        return false;
	      }
	    }
	    return true;
	    ...
	    for (var j = 0; j < children.length; j++) {
	      if (children[j].isLosingNode(evaluator)) {
	        return true;
	      }
	    }
	    return false;
	...
	TicTacToeNode.prototype.isWinningNode = function (evaluator) {
	  ...
	  if (this.board.turn === evaluator) {
	    ...
	    for (var i = 0; i < children.length; i++) {
	      if (children[i].isWinningNode(evaluator)) {
	        return true;
	      }
	    }
	    return false;
	    ...
	    for (var j = 0; j < children.length; j++) {
	      if (!children[j].isWinningNode(evaluator)) {
	        return false;
	      }
	    }
	    return true;
